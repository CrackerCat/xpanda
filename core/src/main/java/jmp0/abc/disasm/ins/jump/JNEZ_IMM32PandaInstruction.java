 ...
 * @Email: jmp0@qq.com
 */
public final class JNEZ_IMM32PandaInstruction extends JumpNotEqualPandaInstruction {
    private final int imm;
    @SneakyThrows
    public JNEZ_IMM32PandaInstruction(int pc, PandaOPCode opCode, byte[] param, PandaMethod pandaMethod) {
