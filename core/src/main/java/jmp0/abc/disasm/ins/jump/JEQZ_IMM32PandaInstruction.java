 ...
 * @Email: jmp0@qq.com
 */
public final class JEQZ_IMM32PandaInstruction extends JumpEqualPandaInstruction {
    private final int imm;
    @SneakyThrows
    public JEQZ_IMM32PandaInstruction(int pc, PandaOPCode opCode, byte[] param, PandaMethod pandaMethod) {
