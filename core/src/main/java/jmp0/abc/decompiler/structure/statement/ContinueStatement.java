 ...
 * @Email: jmp0@qq.com
 */
public final class ContinueStatement implements PandaStatement{
    private final String comment;
    public ContinueStatement(String comment){
        this.comment = comment;
    }
    @Override
    public void decompile(PandaDecompilerMethodHandler methodHandler, PandaLexical pandaLexical, Object astNode) {
        Object breakStatement = methodHandler.getCodeGenerator().getNodeFactory().continueStatement();
        if (comment != null)
